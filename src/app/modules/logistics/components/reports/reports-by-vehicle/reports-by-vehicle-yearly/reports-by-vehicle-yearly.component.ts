...
@Component({
  selector: 'app-reports-by-vehicle-yearly',
  templateUrl: './reports-by-vehicle-yearly.component.html',
  styleUrls: ['./reports-by-vehicle-yearly.component.scss']
})
export class ReportsByVehicleYearlyComponent implements OnInit, OnDestroy {
  //UNSUBSCRIBE METHOD
